...
use hrafnix_keys::parameter_key::ParameterKey;
...
impl ParameterObjectDefinitionBuilder {
    ...
    #[must_use]
    #[cfg_attr(feature = "hotpath", hotpath::measure)]
    pub fn with_at<K: Into<ParameterKey>, T: Into<ItemDefinitionType>>(
        mut self,
        index: usize,
        key: K,
        parameter: T,
    ...
    /// current number of keys.
    #[cfg_attr(feature = "hotpath", hotpath::measure)]
    pub fn insert_at<K: Into<ParameterKey>, T: Into<ItemDefinitionType>>(
        &mut self,
        index: usize,
        key: K,
        parameter: T,
...
impl TreePrint for ParameterObjectDefinition {
    #[cfg_attr(feature = "hotpath", hotpath::measure)]
    fn tree_print(
        &self,
        ...
        writeln!(f, "Parameter Object Definition ({})", self.description())?;
...
impl std::fmt::Display for ParameterObjectDefinition {
    #[cfg_attr(feature = "hotpath", hotpath::measure)]
