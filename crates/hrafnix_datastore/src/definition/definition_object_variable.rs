...
use hrafnix_keys::variable_key::VariableKey;
use hrafnix_message::message::{Message, MessageCategory};
use hrafnix_shareable_string::{ShareableString, SharedStringStore};
...
impl VariableObjectDefinitionBuilder {
    ...
    #[must_use]
    #[cfg_attr(feature = "hotpath", hotpath::measure)]
    pub fn with_before<R: Into<VariableKey>, K: Into<VariableKey>, T: Into<ItemDefinitionType>>(
        mut self,
        reference: R,
        key: K,
        variable: T,
    ) -> Self {
        self.insert_before(reference, key, variable);
        self
    }
    ...
    #[must_use]
    #[cfg_attr(feature = "hotpath", hotpath::measure)]
    pub fn with_after<R: Into<VariableKey>, K: Into<VariableKey>, T: Into<ItemDefinitionType>>(
        mut self,
        reference: R,
        key: K,
        variable: T,
    ) -> Self {
        self.insert_after(reference, key, variable);
        self
    }
    ...
    /// of the ordered keys.
    #[cfg_attr(feature = "hotpath", hotpath::measure)]
    pub fn insert_after<R: Into<VariableKey>, K: Into<VariableKey>, T: Into<ItemDefinitionType>>(
        &mut self,
        reference: R,
        key: K,
        variable: T,
