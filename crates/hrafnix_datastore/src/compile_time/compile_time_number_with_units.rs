...
/// - `preferred_units`: [`UnitId`] (from the `hrafnix_units` crate) the unit the value is displayed
...
/// # Examples
/// ```rust
/// use hrafnix_datastore::compile_time::{NumberConstraint, NumberWithUnitsCompileTime};
