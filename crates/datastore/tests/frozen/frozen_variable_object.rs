...
fn test_editable_variable_object_print() {
    ...
    let frozen_1 = VariableObjectFrozen::new(
        VariableObjectDefinitionBuilder::new("Test")
            ...
            .with(
                VariableKey::new("v_p04_v6".into()).unwrap(),
                IntegerDefinition::new_with_constraint(
                    "D4",
            ...
            .with(
                VariableKey::new("v_p04_v7".into()).unwrap(),
                IntegerDefinition::new_with_constraint(
                    "D4",
            ...
            .with(
                VariableKey::new("v_p04_v8".into()).unwrap(),
                IntegerDefinition::new_with_constraint(
                    "D4",
            ...
            .with(
                VariableKey::new("v_p05_v7".into()).unwrap(),
                NumberDefinition::new_with_constraint(
                    "D5",
            ...
            .with(
                VariableKey::new("v_p05_v8".into()).unwrap(),
                NumberDefinition::new_with_constraint(
                    "D5",
            ...
            .with(
                VariableKey::new("v_p05_v9".into()).unwrap(),
                NumberDefinition::new_with_constraint(
                    "D5",
            ...
            .with(
                VariableKey::new("v_p06".into()).unwrap(),
            ...
            .with(
                VariableKey::new("v_p07".into()).unwrap(),
                TableDefinition::new(
                    "D7",
                    vec![
            ...
            .with(
                VariableKey::new("v_p09".into()).unwrap(),
            ...
            .with(
                VariableKey::new("v_p08".into()).unwrap(),
                MapDefinition::new(
                    "D8",
                    vec![
                        (
    ...
    editable_set_value(&mut editable_1, "v_p01", "edited").unwrap();
    editable_set_value(&mut editable_1, "v_p02", "true").unwrap();
    editable_set_value(&mut editable_1, "v_p03", "test.ext").unwrap();
    editable_set_value(&mut editable_1, "v_p04_v1", "1").unwrap();
    editable_set_value(&mut editable_1, "v_p04_v2", "2").unwrap();
    editable_set_value(&mut editable_1, "v_p04_v3", "3").unwrap();
    editable_set_value(&mut editable_1, "v_p04_v4", "4").unwrap();
    editable_set_value(&mut editable_1, "v_p04_v5", "5").unwrap();
    editable_set_value(&mut editable_1, "v_p04_v6", "6").unwrap();
    editable_set_value(&mut editable_1, "v_p04_v7", "7").unwrap();
    editable_set_value(&mut editable_1, "v_p04_v8", "8").unwrap();
    editable_set_value(&mut editable_1, "v_p05_v1", "1.0").unwrap();
    editable_set_value(&mut editable_1, "v_p05_v2", "2.0").unwrap();
    editable_set_value(&mut editable_1, "v_p05_v3", "3.0").unwrap();
    editable_set_value(&mut editable_1, "v_p05_v4", "4.0").unwrap();
    editable_set_value(&mut editable_1, "v_p05_v5", "5.0").unwrap();
    editable_set_value(&mut editable_1, "v_p05_v6", "6.0").unwrap();
    editable_set_value(&mut editable_1, "v_p05_v7", "7.0").unwrap();
    editable_set_value(&mut editable_1, "v_p05_v8", "8.0").unwrap();
    editable_set_value(&mut editable_1, "v_p05_v9", "9.0").unwrap();
    editable_set_value(&mut editable_1, "v_p06", "test").unwrap();
    ...
    let map = editable_1.get_mut("v_p08").unwrap().get_mut_map().unwrap();
    ...
    editable_set_value(&mut editable_1, "v_p09", "output/files").unwrap();
    ...
    assert_eq!(
        ...
        concat!(
            "Variable Object Frozen (Test)\n",
            "    ├── v_p01 (D1) String - \"edited\"\n",
            "    ├── v_p02 (D2) Boolean - \"true\"\n",
            "    ├── v_p03 (D3) File - \"test.ext\"\n",
            "    ├── v_p04_v1 (D4) Integer - \"1\"\n",
            "    ├── v_p04_v2 (D4) Integer - \"2\"\n",
            "    ├── v_p04_v3 (D4) Integer - \"3\"\n",
            "    ├── v_p04_v4 (D4) Integer - \"4\"\n",
            "    ├── v_p04_v5 (D4) Integer - \"5\"\n",
            "    ├── v_p04_v6 (D4) Integer - \"6\"\n",
            "    ├── v_p04_v7 (D4) Integer - \"7\"\n",
            "    ├── v_p04_v8 (D4) Integer - \"8\"\n",
            "    ├── v_p05_v1 (D5) Number - \"1.0\"\n",
            "    ├── v_p05_v2 (D5) Number - \"2.0\"\n",
            "    ├── v_p05_v3 (D5) Number - \"3.0\"\n",
            "    ├── v_p05_v4 (D5) Number - \"4.0\"\n",
            "    ├── v_p05_v5 (D5) Number - \"5.0\"\n",
            "    ├── v_p05_v6 (D5) Number - \"6.0\"\n",
            "    ├── v_p05_v7 (D5) Number - \"7.0\"\n",
            "    ├── v_p05_v8 (D5) Number - \"8.0\"\n",
            "    ├── v_p05_v9 (D5) Number - \"9.0\"\n",
            "    ├── v_p06 (D6) Choice - \"test\"\n",
            "    ├── v_p07 (D7) Table 1 rows\n",
            "    │   ├── data\n",
            "    │   │   └── Row 0\n",
            "    │   │       ├── col1 \"100.0\"\n",
            "    │   │       └── col2 \"200.0\"\n",
