...
#[test]
fn test_editable_variable_object_round_trip() {
...
fn test_editable_variable_object_print() {
    ...
    item.get_mut("col2")
        ...
        .unwrap()
        .set("55.0");
    let mav_table = item.get_mut("col3").unwrap().get_mut_table().unwrap();
    mav_table.add_row(1);
    mav_table.set_cell(0, "col3_1", "150.0").unwrap();
    mav_table.set_cell(0, "col3_2", "250.0").unwrap();
